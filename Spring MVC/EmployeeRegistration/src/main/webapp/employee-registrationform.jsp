		...
		<div class="form">
			...
			<br> <label for="password"><b>Password</b></label> <input
				...
				required><br> <br> <label for="emp_DOB"><b>
					Enter DOB</b></label> <input type="text" placeholder="Enter DOB" name="emp_DOB"
				required><br>
			...
			<br> <label for=" emp_address"><b>Address</b></label> <input
				...
				required><br> <br> <label for="emp_JDate"><b>Joining
					Date</b></label> <input type="text"
				placeholder="Enter the Joining date" name="emp_JDate" required><br> <br> <label
				for="Department"><b>Department</b></label> <select
				name="emp_department">
